            ...
            <div class="card-content has-text-centered">
              <div class="content">
                ...
                <p>
                  <ul>
                  <?php
                  //através da lista Pokémon busca a próxima evolução
                  if(count($Pokemon->next_evolution)) {
                    echo "Próximas evoluções: ";
                    //se houver próxima evolução, mostrar
                    //foreach serve para ler arrays
                    foreach($Pokemon->next_evolution as $ProximaEvolucao) {
                        echo $ProximaEvolucao->name . " ";
                    }
                    //se não houver próxima evolução, mostrar mensagem
                  } else {
